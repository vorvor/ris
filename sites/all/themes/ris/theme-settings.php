 ...
 */
function ris_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['ris_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('ris sample setting'),
  '#default_value' => theme_get_setting('ris_example'),
